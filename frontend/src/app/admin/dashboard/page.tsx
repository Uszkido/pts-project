...
export default function AdminDashboard() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [dashRes, usersRes, devicesRes, incidentsRes, docsRes, msgsRes, suspectRes, authRes, mapRes] = await Promise.all([
            ...
            const [dashJson, usersData, devicesData, incidentsData, docsData, msgsData, suspectsData, authData, mapJson] = await Promise.all([
                ...
                mapRes.ok ? mapRes.json() : Promise.resolve({ success: true, data: { vendors: [], pings: [] } })
            ]);

            // Unwrap wrapped responses from sendSuccess helper
            const dashData = dashJson?.data || dashJson;
            const mData = mapJson?.data || mapJson;
